<section class="carousel">
    <h3 class="carousel__header sro" role="heading" aria-level="3">
        Carousel
    </h3>
    <button class="carousel__navigation carousel__navigation--left" value="Back">◄</button>
    <div id="frame" class="carousel__frame">

            <img src="./assets/img/lysander-min.jpg"
                 srcset="./assets/img/lysander-min.jpg 1x, ./assets/img/lysander.jpg 2x"
    ...
    <button class="carousel__navigation carousel__navigation--right" value="next">►</button>
</section>