<form action="/mailController.php" method="post" class="form" id="contact-form">
    ...
    <div class="form__area">
        ...
        <input type="text" class="form__input" id="name" name="sender-name"
               ...
               value="<?php if ($_SESSION['true']['nameTrue']) echo $_SESSION['true']['nameTrue']; ?>">
    </div>
    <div class="form__area">
        ...
        <input type="email" class="form__input" id="mail" name="mail" placeholder="p. ex. example@mail.com"
               value="<?php if ($_SESSION['true']['mailTrue']) echo $_SESSION['true']['mailTrue']; ?>">
    </div>
    <div class="form__area">
        ...
        <input type="tel" class="form__input" id="phone" name="phone-number"
               ...
               value="<?php if ($_SESSION['true']['telTrue']) echo $_SESSION['true']['telTrue']; ?>">
    </div>
    ...
    <textarea name="content" id="content" rows="7" maxlength="1400"
              class="form__content"><?= $_SESSION['true']['contentTrue']; ?></textarea>
